...
This section continues from [*Part 4*](./part4.md), so be sure to re-use your
...
![](/assets/images/tutorials/watchface-tutorial/bt-icon.png){: style="background-color:black"}
...
![bt](../../../assets/images/tutorials/watchface-tutorial/bt.png)
